...
public class PrefUtils {
    ...
    public static final String DISPLAY_TIP_FLOATING = "DISPLAY_TIP_FLOATING";
    public static final String DISPLAY_TIP_FEEDS = "DISPLAY_TIP_FEEDS";
    ...
    public static final String POSITION_FLOATING_MENU_BUTTON = "position_floating_button";
