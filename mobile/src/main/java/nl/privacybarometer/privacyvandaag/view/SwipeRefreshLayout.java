...
public class SwipeRefreshLayout extends ViewGroup {
   ...
   // private static final int REFRESH_TRIGGER_DISTANCE = 120;
     ...
     * gesture.
     *
     * Dit kleurenschema wordt zowel door de EntryFragment als door de EntriesListFragment ingesteld.
     *
    ...
    public void setColorScheme(int colorRes1, int colorRes2, int colorRes3, int colorRes4) {
        ...
        final int color1 = DeprecateUtils.getColor(colorRes1,this);
        final int color2 = DeprecateUtils.getColor(colorRes2,this);
        final int color3 = DeprecateUtils.getColor(colorRes3,this);
        final int color4 = DeprecateUtils.getColor(colorRes4,this);
